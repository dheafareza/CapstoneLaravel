        ...
        <div class="card">
            <div class="card-body">
                ...
                <form id="formHutang" action="{{ route('hutang.store') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        <label for="alasan">Alasan Hutang</label>
                        <textarea name="alasan" id="alasan" class="form-control" rows="3" placeholder="Masukkan alasan hutang" required>{{ old('alasan') }}</textarea>
                    </div>
